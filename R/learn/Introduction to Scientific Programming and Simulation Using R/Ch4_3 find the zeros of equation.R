...
#find the zero of a2*x6w + a1*x + a0 = 0
...
a2 <- as.numeric(readline("a2 = "))   #readline reads a line from the terminal (in interactive use)
a1 <- as.numeric(readline("a1 = "))
a0 <- as.numeric(readline("a0 = "))

#calculates the discriminant
discrim <- a1^2 - 4*a2*a0
#calcualate the roots depending on the values of the discriminant
if(discrim > 0){
